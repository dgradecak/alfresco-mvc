...
@Configuration
@ComponentScan(basePackageClasses=AopService.class)
@EnableAlfrescoMvcProxy(basePackageClasses=AopService.class)
public class AlfrescoMvcAopModuleConfig {
  ...
  public DispatcherWebscript dispatcherWebscript() {
    ...
    dispatcherWebscript.setContextConfigLocation(AlfrescoMvcAopServletContext.class.getName());
