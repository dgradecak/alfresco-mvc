...
public class LocalHttpServletResponse implements HttpServletResponse {
	 ...
	 * <p>
	 * As of Servlet 3.0, this method is also defined in HttpServletResponse. As of
	 * Spring 3.1, it returns a stringified value for Servlet 3.0 compatibility.
	 ...
	 * <p>
	 * As of Servlet 3.0, this method is also defined in HttpServletResponse. As of
	 * Spring 3.1, it returns a List of stringified values for Servlet 3.0
	 * compatibility. Consider using {@link #getHeaderValues(String)} for raw Object
	 * access.
	 * 
	 * @param name the name of the header
	...
	public String getIncludedUrl() {
		...
		// Assert.state(count <= 1,() -> "More than 1 URL included - check
		// getIncludedUrls instead: " + this.includedUrls);
