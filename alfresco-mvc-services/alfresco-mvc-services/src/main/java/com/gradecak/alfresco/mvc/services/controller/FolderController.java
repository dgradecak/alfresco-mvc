...
public class FolderController extends AbstractController {
  ...
  public ResponseEntity<?> get(@PathVariable NodeRef id, RootResourceInformation resourceInformation, Pageable pageable) {
    ...
    Page<Persistable<NodeRef>> list = resourceInformation.getInvoker().list(resourceInformation, id, pageable);
    return new ResponseEntity<>(HateaosUtils.createPagedResource(list), HttpStatus.OK);    
  }
}
