...
public class CmFolderPropertiesMapper extends BeanPropertiesMapper<CmFolder> implements BeanPropertiesMapperConfigurer<CmFolder> {
  ...
  public CmFolderPropertiesMapper(final NamespaceService namespaceService, final DictionaryService dictionaryService, final boolean reportNamespaceException) {
